    ...
    return (
        <div className='py-12'>
            ...
            <form className=' flex flex-col md:flex-row justify-center items-center mb-4 md:px-24'>
                <input type="text" placeholder='search' className='bg-white border mt-3 border-gray-300  rounded shadow-md w-2/3 h-13 mr-1 px-4 mb-3 focus:outline-none focus:shadow-outline' />
